...
When drawing an isocube, the visibility of each face of each cube is determined.
...
* Only polygons for visible faces are drawn 
    *  so we don't need painters algorithm for drawing in order from back to front.
...
```{r visibility_simple, echo = FALSE, eval=FALSE}
library(grid)
library(isocubes)
