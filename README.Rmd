...
`isocubes` is a voxel renderer using an fixed-view isometric cube as the rendering primitive.
...
* `xo` and `yo` give the position of the origin of the isometric view within
